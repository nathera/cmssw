...
class AnalyzerClusterStubNew : public edm::EDAnalyzer
{
  /// Public methods
  public:
    /// Constructor/destructor
    explicit AnalyzerClusterStubNew(const edm::ParameterSet& iConfig);
    virtual ~AnalyzerClusterStubNew();
...
//////////////
// CONSTRUCTOR
AnalyzerClusterStubNew::AnalyzerClusterStubNew(edm::ParameterSet const& iConfig) : 
  config(iConfig)
{
...
/////////////
// DESTRUCTOR
AnalyzerClusterStubNew::~AnalyzerClusterStubNew()
{
...
//////////
// END JOB
void AnalyzerClusterStubNew::endJob()//edm::Run& run, const edm::EventSetup& iSetup
{
  /// Things to be done at the exit of the event Loop
  std::cerr << " AnalyzerClusterStubNew::endJob" << std::endl;
  /// End of things to be done at the exit from the event Loop
}

////////////
// BEGIN JOB
void AnalyzerClusterStubNew::beginJob()
{
  ...
  std::cerr << " AnalyzerClusterStubNew::beginJob" << std::endl;
...
//////////
// ANALYZE
void AnalyzerClusterStubNew::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
DEFINE_FWK_MODULE(AnalyzerClusterStubNew);
