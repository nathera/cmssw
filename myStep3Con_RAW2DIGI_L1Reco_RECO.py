...
# with command line options: myStep3Con --conditions auto:upgradePLS3 -n 10 --eventcontent FEVTDEBUGHLT -s RAW2DIGI,L1Reco,RECO --datatier GEN-SIM-RECO --customise SLHCUpgradeSimulations/Configuration/combinedCustoms.cust_2023Muondev --geometry Extended2023Muondev,Extended2023MuondevReco --magField 38T_PostLS1 --filein file:step2.root --fileout file:myStep3Con.root
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:myStep2Con.root')
)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('myStep3Con nevts:10'),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:myStep3Con.root'),
...
process.siStripMatchedRecHits.VerbosityLevel = cms.untracked.int32(10)
